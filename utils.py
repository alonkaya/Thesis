...
def adjust_points(keypoints_dict, idx, top_crop, left_crop, width, height):
    ...
    print(f'1:   {pts1, pts2, top_crop, left_crop, width, height}')
    ...
    pts1 *= scale
    pts2 *= scale
    print(f'2:   {pts1, pts2, top_crop, left_crop, width, height}')
    ...
    pts1 -= crop_offset
    pts2 -= crop_offset
    print(f'3:   {pts1, pts2, top_crop, left_crop, width, height}')
    return pts1, pts2
