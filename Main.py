...
average embeddings: {AVG_EMBEDDINGS}, customdataset type: {CUSTOMDATASET_TYPE}, model: {MODEL}, augmentation: {AUGMENTATION}, enforce_rank_2:{ENFORCE_RANK_2}\n\n"""
        print_and_write(parameters)

        model.train_model(train_loader, val_loader, num_epochs=300)
