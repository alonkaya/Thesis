...
if __name__ == "__main__":
        ...
        for i, (alg_coeff, re1_coeff, sed_coeff, seed, train_size, lr, bs, part, fl) in enumerate(param_combinations):
                ...
                if STEREO:
                        num_epochs = 2000 if train_size==0.3 else 3000 if train_size==0.2 else 4000 if train_size==0.1 else 8000 if train_size==0.05 else 10000 if train_size==0.0375 else 14000 if train_size==0.025 else 25000 if train_size==0.015 else 35000 if train_size==0.008 else 0
                elif USE_REALESTATE:
                        num_epochs = 5000 
                if num_epochs == 0:
