...
if __name__ == "__main__":
        ...
        for i, (alg_coeff, re1_coeff, sed_coeff, data_ratio, lr, bs) in enumerate(param_combinations):
                ...
                num_epochs = 2001 if data_ratio==0.3 else 3000 if data_ratio==0.2 else 4000 if data_ratio==0.1 else 5500 if data_ratio==0.05 else 6000 if data_ratio==0.025 else 0
