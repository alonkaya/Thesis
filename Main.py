...
enforce_rank_2:{ENFORCE_RANK_2}, predict pose: {PREDICT_POSE}, SVD coeff: {SVD_COEFF}, RE1 coeff: {RE1_COEFF} SED coeff: {SED_COEFF}, ALG_COEFF: {ALG_COEFF}, unforzen layers: {UNFROZEN_LAYERS}, group conv: {GROUP_CONV}\n\n"""
