...
if __name__ == "__main__":
        ...
        for i, (alg_coeff, re1_coeff, sed_coeff, seed, train_size, lr, part, fl) in enumerate(param_combinations):
                ...
                if SCENEFLOW and FLYING:
                        num_epochs = 8000 if train_size==170 else 18000 if train_size==80 else 45000 if train_size==9 else 0
                else:
                ...
                elif model.start_epoch < model.num_epochs+100000:
...
RE1 coeff: {re1_coeff} SED coeff: {sed_coeff}, ALG_COEFF: {alg_coeff}, L2_coeff: {L2_coeff}, huber_coeff: {huber_coeff}, frozen layers: {fl}, trained vit: {TRAINED_VIT}, MAX_POOL_SIZE: {MAX_POOL_SIZE}
