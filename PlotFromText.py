...
if __name__ == "__main__":
    plots_path = "plots/RealEstate/SED_0.1__transposed__both__lr_2e-05__avg_embeddings_True__model_CLIP__use_reconstruction_True__Augmentation_False__Conv_False"
