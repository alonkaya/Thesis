...
def plot_by_output(plots_path, save):
...
if __name__ == "__main__":
    root_path = "plots/Stereo/Winners/SED_0.5__L2_1__huber_1__lr_0.0001__conv__Resnet__use_reconstruction_True/BS_8__ratio_0.004__mid__frozen_0__seed_300"
    save = False

    plot_by_output(root_path, save)
