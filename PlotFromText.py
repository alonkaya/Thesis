...
if __name__ == "__main__":
    plots_path = "plots/RealEstate/SVD_0__RE1_0__SED_0.01__ALG_0__lr_2e-05__avg_embeddings_True__model_CLIP__use_reconstruction_True__Augmentation_False__Conv_True"
