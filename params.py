...
SEQ_RATIOS = [0.0375, 0.025, 0.1]      # 3251, 2166, 1082, 540, 405, 269
CROP = 224
RESIZE = 256
...
TRAINED_VIT = "plots/Affine/model.pth" # This is for when wanting to fine-tune an already trained vit (for example fine-tuning a vit which had been trained on the affine transfomration task)
