...
if __name__ == "__main__":
    ...
    p1 = "SED_0.5__L2_1.0__huber_1.0__auged__lr_0.0005__conv__CLIP__use_reconstruction_True__BS_32__WD_5e-05"
    p2 = "SED_0.5__L2_0.5__huber_0.5__auged__lr_0.0005__conv__CLIP__use_reconstruction_True__BS_16__WD_5e-05"
    for file in os.listdir("plots/Stereo"):
        if file == p1 or file == p2:
            continue
