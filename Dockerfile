...
COPY poses utils.py task.py requirements.txt params.py Main.py FunMatrix.py  FMatrixRegressor.py Dockerfile  docker.yaml sequences deepF_nocors.py Dataset.py CustomDataset.py /home/alonkay/app/
